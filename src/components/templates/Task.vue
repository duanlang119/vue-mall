<template>
  <div>
    ...
    <el-breadcrumb separator-class="el-icon-arrow-right">
      ...
      <el-breadcrumb-item>Project Config</el-breadcrumb-item>
    ...
    <el-card>
      ...
      <el-row :gutter="20">
        <el-col :span="8">
          <el-input placeholder="Search Task" v-model="queryInfo.query" clearable @clear="getTasksList">
            <el-button slot="append" icon="el-icon-search" @click="getTasksList"></el-button>
          </el-input>
        </el-col>
        <el-col :span="4">
          <el-button type="primary" @click="addDialogVisible = true">Add Task</el-button>
        </el-col>
      </el-row>
      ...
      <el-table :data="taskslist" border stripe>
        ...
        <el-table-column label="Task" prop="taskname" width="680px"></el-table-column>
        <el-table-column
          prop="groupname"
          label="Group"
          width="100"
    ...
    <!-- 添加用户的对话框 -->
    <el-dialog title="Add Task" :visible.sync="addDialogVisible" width="50%" @close="addDialogClosed">
      <!-- 内容主体区域 -->
      <el-form :model="addForm" :rules="addFormRules" ref="addFormRef" label-width="170px">
        ...
        <el-form-item label="Group" prop="groupname">
          <el-select v-model="addForm.groupname" placeholder="Select Group">
            <el-option label="Group 001" value="Group 001"></el-option>
            <el-option label="Group 002" value="Group 002"></el-option>
          </el-select>
        </el-form-item>
      ...
      <span slot="footer" class="dialog-footer">
        <el-button @click="addDialogVisible = false">Cancle</el-button>
        <el-button type="primary" @click="addUser">Add Task</el-button>
      </span>
    </el-dialog>
        ...
        addFormRules: {
          taskname: [
            { required: true, message: 'Please input task', trigger: 'blur' },
            {
              min: 3,
              max: 100,
              message: 'task length should in 3~100',
              trigger: 'blur'
            }
          ],
          groupname: [
            { required: true, message: 'Select Group', trigger: 'change' }
          ]
        },
        // 控制修改用户对话框的显示与隐藏
